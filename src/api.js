...
// 查询单个帖子详情
const RELEASE_INFO = `${HOSTS}xianyu/comment/getGoodsInfobByOrderId`
...
export default {
  ...
  goods: {
    ...
    getGoodsList: (jsons) => { // 帖子列表详情
      return HTTP.get(RELEASE_LIST, {params: jsons})
    },
    getGoodsInfo: (jsons) => { // 帖子列表详情
      return HTTP.get(RELEASE_INFO, {params: jsons})
    }
  }
}
